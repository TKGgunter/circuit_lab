...
//!
//! This documentation is meant to serve as guide for future developers. It is meant help developers who wish
//! to further develop this program. If you are new to rust please take a look 
//! [here](https://www.rust-lang.org/learn/get-started), the rust installation guide, and
//! [here](https://doc.rust-lang.org/book/), a beginner to intermediate guide which might be useful for those getting
...
//! # Getting started
//!
//! Compilation is done using rust's default compilation and packaging tool, `cargo`.
...
//! Note, first time compilation will attempt to download external dependencies from rust's
//! package registry. 
//!
//!
//! The main logic path begins in `main.rs` then diverges depending on the operating system.
//! These paths converge in `lab_sim.rs`. Logic specific to the circuit simulation can be found
